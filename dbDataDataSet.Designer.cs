...
namespace FLA7 {
    ...
    public partial class dbDataDataSet : global::System.Data.DataSet {
        ...
        public partial class StudentsDataTable : global::System.Data.TypedTableBase<StudentsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public StudentsRow AddStudentsRow(string FirstName, string LastName, string Course, int YearLevel, string Picture) {
...
namespace FLA7.dbDataDataSetTableAdapters {
    ...
    public partial class StudentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Students] ([StudentId], [FirstName], [LastName], [Course], [YearLevel], [Picture]) VALUES (@StudentId, @FirstName, @LastName, @Course, @YearLevel, @Picture);
SELECT StudentId, FirstName, LastName, Course, YearLevel, Picture FROM Students WHERE (StudentId = @StudentId)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Students] SET [StudentId] = @StudentId, [FirstName] = @FirstName, [LastName] = @LastName, [Course] = @Course, [YearLevel] = @YearLevel, [Picture] = @Picture WHERE (([StudentId] = @Original_StudentId) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)) AND ((@IsNull_Course = 1 AND [Course] IS NULL) OR ([Course] = @Original_Course)) AND ((@IsNull_YearLevel = 1 AND [YearLevel] IS NULL) OR ([YearLevel] = @Original_YearLevel)));
SELECT StudentId, FirstName, LastName, Course, YearLevel, Picture FROM Students WHERE (StudentId = @StudentId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::FLA7.Properties.Settings.Default.dbDataConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT StudentId, FirstName, LastName, Course, YearLevel, Picture FROM dbo.Studen" +
                "ts";
        ...
        public virtual int Fill(dbDataDataSet.StudentsDataTable dataTable) {
        ...
        public virtual dbDataDataSet.StudentsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            dbDataDataSet.StudentsDataTable dataTable = new dbDataDataSet.StudentsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(dbDataDataSet.StudentsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_StudentId, string Original_FirstName, string Original_LastName, string Original_Course, global::System.Nullable<int> Original_YearLevel) {
            ...
            if ((Original_YearLevel.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[8].Value = ((int)(Original_YearLevel.Value));
            }
            else {
        ...
        public virtual int Insert(int StudentId, string FirstName, string LastName, string Course, global::System.Nullable<int> YearLevel, string Picture) {
        ...
        public virtual int Update(int StudentId, string FirstName, string LastName, string Course, global::System.Nullable<int> YearLevel, string Picture, int Original_StudentId, string Original_FirstName, string Original_LastName, string Original_Course, global::System.Nullable<int> Original_YearLevel) {
            ...
            if ((Original_YearLevel.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[14].Value = ((int)(Original_YearLevel.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, string LastName, string Course, global::System.Nullable<int> YearLevel, string Picture, int Original_StudentId, string Original_FirstName, string Original_LastName, string Original_Course, global::System.Nullable<int> Original_YearLevel) {
            return this.Update(Original_StudentId, FirstName, LastName, Course, YearLevel, Picture, Original_StudentId, Original_FirstName, Original_LastName, Original_Course, Original_YearLevel);
        }
    }
